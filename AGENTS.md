...
This project is indexed by GitNexus as **always** (3798 symbols, 9410 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
