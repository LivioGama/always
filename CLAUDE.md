...
This project is indexed by GitNexus as **always** (2546 symbols, 5676 relationships, 222 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
